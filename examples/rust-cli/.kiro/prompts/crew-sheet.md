...
| crew-creator | Crew Creator — creates agent teams for new projects | `/agent crew-creator` or `ctrl+shift+c` |
| crew-augmenter | Crew Augmenter — adds agents/features to existing crews | `/agent crew-augmenter` |
| crew-doctor | Crew Doctor — diagnoses and fixes agent team issues | `/agent crew-doctor` or `ctrl+shift+f` |
