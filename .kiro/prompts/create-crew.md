...
5. Add project to `.crews/crew.yaml` under `projects:` with:
...
7. Create `<project>/.crews/crew.yaml` if custom, otherwise base crews sync automatically
8. Create `<project>/.kiro/steering/project.md` with project context
...
- `.crews/crew.yaml` — project added to registry
